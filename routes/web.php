...
// ── Auth-protected ────────────────────────────────────────────────────────────
// Everything below requires login — dashboard, markets/stocks, search, signals,
// top picks, IPO checker, and screener are no longer publicly browsable; only
// the landing page ('/') stays public so logged-out visitors have somewhere to
// see the pitch and log in from.
