    ...
    <aside id="sidebar"
        ...
        <div style="padding:0.75rem;border-top:1px solid #e2e8f0;">
            ...
            <div style="display:flex;align-items:center;gap:0.75rem;padding:0.5rem;">
                <a href="{{ route('profile.edit') }}" style="display:flex;align-items:center;gap:0.75rem;flex:1;min-width:0;text-decoration:none;">
                    ...
                    <div style="flex:1;min-width:0;">
                        ...
                        <div style="font-size:0.7rem;color:#94a3b8;">Profile settings</div>
                    </div>
                </a>
                <a href="{{ route('profile.edit') }}" title="Profile settings" style="color:{{ request()->routeIs('profile.edit') ? '#14532D' : '#94a3b8' }};padding:0.25rem;display:flex;" onmouseover="this.style.color='#14532D'" onmouseout="this.style.color='{{ request()->routeIs('profile.edit') ? '#14532D' : '#94a3b8' }}'">
                    <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" title="Log out" style="background:transparent;border:none;cursor:pointer;color:#94a3b8;padding:0.25rem;" onmouseover="this.style.color='#64748b'" onmouseout="this.style.color='#94a3b8'">
                        <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
